...
class OrganismosStoreRequest extends APIRequest
{
    /**
        ...
        return [
            'descripcion' => [
                ...
                Rule::unique(Organismo::class)
                    ...
                    return $query
                        ->where(['descripcion' => request()->descripcion, 'id' => request()->id]);
                }),
            ],
            'estado' => 'in:A,B',
            ...
            'zona_id' => 'required|exists:Modules/Municipalidades/Entities/Zona,zona_id',
            'municipalidad_id' => 'required|exists:Modules/Municipalidades/Entities/Municipalidad,municipalidad_id'
        ];
    }
}
